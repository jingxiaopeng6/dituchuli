    ...
    <div className="relative h-screen w-screen overflow-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 flex h-full w-full flex-col">
        ...
        <div className="min-h-0 flex-1 px-5 py-4">
          <div className="grid h-full min-h-0 grid-cols-1 gap-5 2xl:gap-6 xl:grid-cols-[minmax(320px,350px)_minmax(0,1fr)_minmax(330px,370px)]">
            {/* 左侧侧边栏 */}
            <motion.aside
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-sky-500/3" />
              {leftSidebar}
            </motion.aside>
